...
public class DogAnswers {
    ...
    public String shelter, petName, petAgeNum, petSex, petStatus, petDesc, imageName, petID, q10, petType;
    public boolean petExact;

    public DogAnswers(){}
    public DogAnswers(String shelter, String petName, String petAgeNum, boolean petExact, String petSex, String petStatus, String petDesc,
