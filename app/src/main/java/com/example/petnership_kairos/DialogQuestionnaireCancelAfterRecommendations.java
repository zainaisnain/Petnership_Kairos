...
public class DialogQuestionnaireCancelAfterRecommendations extends DialogFragment{

    Button returnBtn, exitBtn;
    @Override
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.fragment_dialog_questionnaire_cancel_after_recommendations, container, false);

        exitBtn = view.findViewById(R.id.buttonRecExit);
...
//
        ...
        returnBtn = view.findViewById(R.id.buttonRecReturn);
